...
$filetypes = "jpg,png,bmp,gif"; //allowable filetypes
...
$_SESSION['upload_directory'] = $email_hash . "/eventPic/$media_group_id/";
...
<h2>Event Picture Upload</h2>
<div id="filelist"></div>
<br />
<div id="container">
    <button onclick="let pick = document.getElementById('pickfiles');pick.click();">Select Photos<input type="file" style="display: none;" accept="audio/*" id="pickfiles" value="[Select file]" /></button>
    <button class="btn-success" id="upload-trigger" onclick="set_file_names();document.getElementById('uploadfiles').click();">
        Save Photo(s) To Post
    </button>
...
<script type="text/javascript">
    ...
    var uploader = new plupload.Uploader({
        ...
        url: '../src/event_media_upload.php',
        chunk_size: '200kb',
        max_retries: 3,
